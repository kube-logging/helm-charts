...
If you find a bug or a documentation issue, please [report it](https://github.com/kube-logging/helm-charts/issues/new) or, even better, fix it.
...
If you think a feature is missing, please [make a suggestion](https://github.com/kube-logging/helm-charts/issues/new) or, even better, implement it.
...
You can find the currently used version in the [.tool-versions](https://github.com/kube-logging/helm-charts/blob/master/.tool-versions) file at the root of this repository.
...
Fork the project on [GitHub](https://github.com/kube-logging/helm-charts) by clicking on the _Fork_ button in the right upper corner and clone the repository:

```bash
git clone git@github.com:YOUR-GITHUB-USERNAME/helm-charts.git
cd helm-charts
git remote add upstream https://github.com/kube-logging/helm-charts.git
git fetch upstream
```
